...
(
    ...
    '<p>El próximo <strong>sábado 22 de marzo de 2026</strong> a las <strong>10:00 AM</strong> se disputará el esperado <em>Clásico Interfacultades</em> en la Cancha Principal del campus.</p><p><strong>Equipos</strong></p><ul><li>⚙️ <strong>Ingeniería FC</strong> — Campeones del torneo 2025</li><li>📊 <strong>Administración United</strong> — Subcampeones del torneo 2025</li></ul><p><strong>Detalles del evento:</strong></p><ul><li>📅 Fecha: 22 de marzo de 2026</li><li>⏰ Hora: 10:00 AM – 1:00 PM</li><li>📍 Lugar: Cancha Principal, Zonas Deportivas</li><li>🏆 Premio: Trofeo Interfacultades + puntos para el Campeonato Anual</li></ul><p>¡Entrada libre para toda la comunidad estudiantil! Ven con tu camiseta y apoya a tu facultad. 🎉</p>',
    9,
    'Deporte',
    TRUE,
    TRUE,
